...
/**
 * Base interface for all QueryService.
 *
...
export interface QueryService<DTO, C = DeepPartial<DTO>, U = DeepPartial<DTO>> {
   ...
   */
  findById(context: IContext, id: string | number | object, opts?: FindByIdOptions<DTO>): Promise<DTO | undefined>;
...
/**
 * QueryService decorator to register
